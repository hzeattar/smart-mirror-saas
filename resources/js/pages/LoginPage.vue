...
<template>
  <div class="auth-page">
    <div class="auth-visual">
      ...
      <div class="auth-copy">
        <span class="kicker">AR retail operating system</span>
        <h1>Turn every fitting room into a measurable sales channel.</h1>
        <p>Manage garments, smart mirrors, sizing data and customer requests from one place.</p>
      </div>
    </div>
    ...
    <form class="auth-card" @submit.prevent="submit">
      ...
      <button class="btn btn-primary btn-wide" :disabled="auth.state.loading">
