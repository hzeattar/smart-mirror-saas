...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--calibration-screen", action=argparse.BooleanOptionalAction, default=False)
    p.add_argument("--pose-every-n", type=int, default=3)
    p.add_argument("--hand-every-n", type=int, default=3)
