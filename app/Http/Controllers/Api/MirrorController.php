    ...
    public function catalog(Request $request, ?Mirror $mirror = null): JsonResponse
    {
        ...
        $products = Product::query()
            ...
            ->map(fn (Product $product) => [
                ...
                'measurement_schema_version' => (int) $product->measurement_schema_version,
                'measurement_basis' => $product->measurement_basis,
                ...
                'sizes' => $product->sizingCharts->map(fn ($size) => [
                    ...
                    'inseam_length_cm' => $size->inseam_length_cm !== null ? (float) $size->inseam_length_cm : null,
